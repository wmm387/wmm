...
import com.wangyuanwmm.wmm.customtabs.CustomFallback;
import com.wangyuanwmm.wmm.customtabs.CustomTabActivityHelper;
        ...
        try {
            ...
            switch (type) {
                case TYPE_ZHIHU:
                    ...
                    break;
                case TYPE_GUOKR:
                    intent.setData(Uri.parse(StaticClass.GUOKR_ARTICLE_LINK_V1 + id));
                    break;
                case TYPE_DOUBAN:
        ...
        try {
            ...
            switch (type) {
                case TYPE_ZHIHU:
                    ...
                    break;
                case TYPE_GUOKR:
                    shareText += StaticClass.GUOKR_ARTICLE_LINK_V1 + id;
                    break;
                case TYPE_DOUBAN:
    ...
    public void copyLink() {
        ...
        switch (type) {
            case TYPE_ZHIHU:
                ...
                break;
            case TYPE_GUOKR:
                clipData = ClipData.newPlainText("text", Html.fromHtml(StaticClass.GUOKR_ARTICLE_LINK_V1 + id).toString());
                break;
            case TYPE_DOUBAN:
        ...
        switch (type) {
            case TYPE_ZHIHU:
                if (UtilTools.networkConnected(context)) {
                    model.load(StaticClass.ZHIHU_NEWS + id, new OnStringListener() {
                        @Override
            ...
            case TYPE_GUOKR:
                if (UtilTools.networkConnected(context)) {
                    model.load(StaticClass.GUOKR_ARTICLE_LINK_V1 + id, new OnStringListener() {
                        @Override
                        public void onSuccess(String result) {
            ...
            case TYPE_DOUBAN:
                if (UtilTools.networkConnected(context)) {
                    model.load(StaticClass.DOUBAN_ARTICLE_DETAIL + id, new OnStringListener() {
                        @Override
                        public void onSuccess(String result) {
                            try {
