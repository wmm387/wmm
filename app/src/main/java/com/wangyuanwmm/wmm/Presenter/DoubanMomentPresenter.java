...
import com.wangyuanwmm.wmm.Interface.DoubanMomentContract;
...
public class DoubanMomentPresenter implements DoubanMomentContract.Presenter {
    ...
    public void loadPosts(long date, final boolean clearing) {
        ...
        if (UtilTools.networkConnected(context)) {
            ...
            model.load(StaticClass.DOUBAN_MOMENT + new UtilTools().DoubanDateFormat(date), new OnStringListener() {
                @Override
